              ...
              <section class="section upload">
                <div class="form-line">
                  ...
                  <div class="custom-upload">
                    <input type="file" name="img" id="basicImage" class="input input-file">
                ...
                <div class="form-line">
                  ...
                  <div class="custom-upload m-disabled">
                    <input type="file" name="img" disabled id="waterMark" class="input input-file">
                    <div class="imitation-upload">
                      <div class="icon-upload"></div>
              ...
              <section class="section opacity disabled">
                ...
                <div class="wmark-opacity">
                  <div class="opacity-slider">
                    <input type="range" min="0" max="1" step="0.05" value="1" class="opacity-range ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"> </div>
                </div>
              </section>
              <!--Created by Vital on 26.08.2015.
              -->
